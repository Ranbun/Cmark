...
SceneLayoutSettings::LSize SceneLayoutSettings::m_PreViewImageSize = SceneLayoutSettings::LSize{960, 720};
...
void SceneLayoutSettings::updateLogoPosition()
{
    ...
    m_LogoPosition.x =
        (sceneW - m_RightTextOffset - m_RightMaxWidth - m_SplitRectWidth - 2 * m_LogoSplitRectSpace - m_LogoSize.w);
